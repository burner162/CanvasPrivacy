// Content script that injects protection code directly into the page
// This combines the injection wrapper with your early-inject.js code

(function () {
    'use strict';

    // The protection script that needs to run in the page context
    ...
    script.textContent = protectionCode;
    ...
    if (document.documentElement) {
        ...
        // Wait for documentElement if it doesn't exist yet
